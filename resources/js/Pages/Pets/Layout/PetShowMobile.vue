...
<template>
    <div class="flex w-full flex-col items-center justify-center gap-10 p-6">
        <Head :title="pet.name" />
            ...
            >
                ...
                >
                    <div class="flex flex-col gap-6">
                        <div class="flex flex-col gap-2 text-[#275342]">
                            <div
                                class="flex flex-row justify-between items-center h-full gap-4"
                            >
                                <img
                                    :src="
                                ...
                                />
                                <div
                                    class="flex flex-col justify-start h-60 w-2/3"
                                >
                                    <div
                                        class="w-full h-1/3 flex justify-start items-start justify-end gap-2"
                                    >
                                        <Link
                ...
                >
                    <div class="flex flex-col gap-6">
                        <div class="flex flex-row justify-between items-center">
                            <h3
                                class="text-base text-lg font-semibold text-[#275342]"
                            >
                                Meeldetuletused
                            </h3>
                            <Link
        ...
        >
            ...
            >
                ...
                <p class="text-sm text-[#275342] text-center">
                    ...
                    <strong>{{ pet.name }}</strong> kustutada? Seda tegevust ei
                    saa tagasi võtta.
                </p>
