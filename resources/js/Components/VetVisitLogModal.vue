...
<template>
    ...
    <Teleport to="body">
        ...
        >
            <!-- Modal card -->
            <div class="relative w-full max-w-sm bg-[#F0F4EF] rounded-2xl shadow-2xl overflow-hidden">
                ...
                <div class="p-5 flex flex-col gap-4">
                            ...
                            <div class="flex items-center justify-between mb-3">
                                ...
                                <div class="flex items-center gap-3">
                                    <button @click="prevMonth"
                                        class="text-gray-400 hover:text-[#2D5A3D] transition">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none"
                                            viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    <textarea
                        ...
                        class="w-full bg-white border border-gray-200 rounded-xl px-4 py-3 text-sm text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#2D5A3D]/40 transition resize-none"
                    />
